...
The project compares **PPO** (on-policy) and **SAC** (off-policy) on the **HalfCheetah-v4** MuJoCo environment.
...
Both PPO and SAC were first trained using baseline hyperparameters on the HalfCheetah-v4 environment.  
